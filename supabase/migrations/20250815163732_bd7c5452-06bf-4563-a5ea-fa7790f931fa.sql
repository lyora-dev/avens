...
ALTER TABLE public.galleries ADD COLUMN event_type_id UUID REFERENCES public.event_types(id);
ALTER TABLE public.galleries ADD COLUMN before_image_url TEXT;
ALTER TABLE public.galleries ADD COLUMN after_image_url TEXT;
ALTER TABLE public.galleries ADD COLUMN is_hero BOOLEAN DEFAULT false;
